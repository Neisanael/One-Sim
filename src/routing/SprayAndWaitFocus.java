...
public class SprayAndWaitFocus extends ActiveRouter {
    ...
    public SprayAndWaitFocus(Settings s) {
        super(s);
    ...
    public SprayAndWaitFocus(SprayAndWaitFocus snf) {
        super(snf);
    ...
    private void updateTransitivePreds(DTNHost host) {
        ...
        assert otherRouter instanceof SprayAndWaitFocus
                : "SprayAndWait Only " + "With Other Router of same time";
        double pForHost = getPredsFor(host); // p (a,b)
        Map<DTNHost, Double> othersPreds = ((SprayAndWaitFocus) otherRouter).getDeliveryPreds();
    ...
    private Tuple<Message, Connection> tryOtherMessages() {
        ...
        for (Connection con : getConnections()) {
            ...
            SprayAndWaitFocus othRouter = (SprayAndWaitFocus) other.getRouter();
    ...
    private class TupleComparator implements Comparator<Tuple<Message, Connection>> {
        ...
        public int compare(Tuple<Message, Connection> tuple1,
            ...
            double p1 = ((SprayAndWaitFocus) tuple1.getValue().getOtherNode(getHost()).getRouter())
                    .getPredsFor(
                            tuple1.getKey().getTo());
            // -"- tuple2...
            double p2 = ((SprayAndWaitFocus) tuple2.getValue().getOtherNode(getHost()).getRouter())
                    .getPredsFor(
                            tuple2.getKey().getTo());
    ...
    public MessageRouter replicate() {
        return new SprayAndWaitFocus(this);
    }
